...
SECRET_KEY = 't7*foda1x^%d+hjk6_c9tp0(5*7u+9y&55667y=u2u&exl=6(6'
...
INSTALLED_APPS = [
    ...
    'django.contrib.humanize', # adding this so that price will have commas
]
...
# Update settings to work with postgresql
# After updating these settings run: python manage.py migrate
DATABASES = {
    'default': {
